 ...
 * connecting to the server , creating the queues and
 * returning the channel object for functionality extentions.
 *
...
export async function bootstrapRMQ(): Promise<void> {
  ...
  RabbitMQChannel.getInstance().setChannel(channel);
}